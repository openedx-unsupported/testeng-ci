...
class MockImages:
    ...
    def filter(self, *args, **kwargs):  # lint-amnesty, pylint: disable=missing-function-docstring, unused-argument
...
class DeregisterAmisTestCase(TestCase):
    ...
    @patch('boto3.resource', return_value=MockEC2(matching_image_exists=False))
    def test_main_no_deregister(self, mock_ec2):  # lint-amnesty, pylint: disable=unused-argument
        """
...
class DeregisterExceptionTestCase(TestCase):
    ...
    def test_cant_get_instances(self, mock_ec2):  # lint-amnesty, pylint: disable=unused-argument
