...
def get_build_counts(org):
    ...
    for repo in repos:
        ...
        main_count += repo_build_total
        main_started_count += num_started

    logger.debug('--------')
    logger.info("overall_total=" + str(main_count))
    logger.info("overall_started=" + str(main_started_count))
    logger.info("overall_queued=" + str(main_count - main_started_count))
